...
<div class="bg1">
    <img style=" width: 1000px; height: 300px; margin-top: 15px;margin-bottom: 15px;" src="images/banner.png" alt="..." class="img-thumbnail">
    </div>
